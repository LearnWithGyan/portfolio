    ...
    <div className="container" data-aos="fade-up">
        ...
        <div className="row mt-1">
            ...
            <div className="col-lg-8 mt-5 mt-lg-0">
                ...
                <form action="SendMail" method="post" role="form" className="php-email-form">
                    <div className="row">
                    ...
                    <div className="form-group mt-3">
                        <textarea className="form-control" name="body" rows="5" placeholder="Message" required></textarea>
                    </div>
                    <div className="my-3">
                        <div className="loading">Loading</div>
                        <div className="error-message"></div>
                        <div className="sent-message">Thank you for contacting us, our team will reach to you as soon as possible.</div>
                    </div>
